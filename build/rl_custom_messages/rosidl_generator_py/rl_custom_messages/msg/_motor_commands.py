    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rl_custom_messages.msg.MotorCommands')
            logger.debug(
...
class MotorCommands(metaclass=Metaclass_MotorCommands):
    ...
    def __init__(self, **kwargs):
        ...
        self.commands = array.array('i', kwargs.get('commands', []))
    ...
    def commands(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'commands' array.array() must have the type code of 'i'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'commands' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._commands = array.array('i', value)
