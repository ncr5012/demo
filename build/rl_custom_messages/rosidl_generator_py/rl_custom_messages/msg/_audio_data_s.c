...
bool rl_custom_messages__msg__audio_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rl_custom_messages.msg._audio_data.AudioData", full_classname_dest, 44) == 0);
  }
  rl_custom_messages__msg__AudioData * ros_message = _ros_message;
  {  // sample_rate
  ...
  {  // channels
    ...
    assert(PyLong_Check(field));
    ros_message->channels = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // data
...
PyObject * rl_custom_messages__msg__audio_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rl_custom_messages.msg._audio_data");
