...
bool rl_custom_messages__msg__image_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rl_custom_messages.msg._image_array.ImageArray", full_classname_dest, 46) == 0);
  }
  rl_custom_messages__msg__ImageArray * ros_message = _ros_message;
  {  // height
...
{
  /* NOTE(esteve): Call constructor of ImageArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rl_custom_messages.msg._image_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImageArray");
