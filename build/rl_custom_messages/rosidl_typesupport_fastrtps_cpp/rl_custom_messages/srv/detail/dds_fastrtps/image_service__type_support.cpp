...
#include "rl_custom_messages/srv/detail/image_service__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rl_custom_messages::srv::ImageService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rl_custom_messages::srv::ImageService_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ImageService_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rl_custom_messages::srv::ImageService_Request *>(
...
static size_t _ImageService_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ImageService_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ImageService_Request__callbacks = {
...
static rosidl_message_type_support_t _ImageService_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImageService_Request__callbacks,
...
{
  return &rl_custom_messages::srv::typesupport_fastrtps_cpp::_ImageService_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const rl_custom_messages::srv::ImageService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rl_custom_messages::srv::ImageService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ImageService_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rl_custom_messages::srv::ImageService_Response *>(
...
static size_t _ImageService_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ImageService_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ImageService_Response__callbacks = {
  "rl_custom_messages::srv",
...
static rosidl_message_type_support_t _ImageService_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImageService_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &rl_custom_messages::srv::typesupport_fastrtps_cpp::_ImageService_Response__handle;
}
...
static service_type_support_callbacks_t _ImageService__callbacks = {
  "rl_custom_messages::srv",
  "ImageService",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rl_custom_messages, srv, ImageService_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rl_custom_messages, srv, ImageService_Response)(),
...
static rosidl_service_type_support_t _ImageService__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImageService__callbacks,
...
{
  return &rl_custom_messages::srv::typesupport_fastrtps_cpp::_ImageService__handle;
}
