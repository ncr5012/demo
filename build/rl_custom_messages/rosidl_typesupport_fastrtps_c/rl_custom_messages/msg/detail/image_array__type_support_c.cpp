...
#include "rl_custom_messages/msg/detail/image_array__rosidl_typesupport_fastrtps_c.h"
...
using _ImageArray__ros_msg_type = rl_custom_messages__msg__ImageArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ImageArray__ros_msg_type * ros_message = static_cast<const _ImageArray__ros_msg_type *>(untyped_ros_message);
  // Field name: height
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ImageArray__ros_msg_type * ros_message = static_cast<_ImageArray__ros_msg_type *>(untyped_ros_message);
  // Field name: height
  {
    cdr >> ros_message->height;
  }
...
static uint32_t _ImageArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rl_custom_messages__msg__ImageArray(
...
static size_t _ImageArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rl_custom_messages__msg__ImageArray(
...
static message_type_support_callbacks_t __callbacks_ImageArray = {
...
static rosidl_message_type_support_t _ImageArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ImageArray,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rl_custom_messages, msg, ImageArray)() {
  return &_ImageArray__type_support;
}
