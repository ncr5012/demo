...
rl_custom_messages__srv__EmotionService_Request__create()
{
  ...
  rl_custom_messages__srv__EmotionService_Request * msg = (rl_custom_messages__srv__EmotionService_Request *)allocator.allocate(sizeof(rl_custom_messages__srv__EmotionService_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rl_custom_messages__srv__EmotionService_Request));
  bool success = rl_custom_messages__srv__EmotionService_Request__init(msg);
  if (!success) {
...
rl_custom_messages__srv__EmotionService_Request__destroy(rl_custom_messages__srv__EmotionService_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rl_custom_messages__srv__EmotionService_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rl_custom_messages__srv__EmotionService_Request__Sequence__init(rl_custom_messages__srv__EmotionService_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rl_custom_messages__srv__EmotionService_Request * data = NULL;

  if (size) {
    data = (rl_custom_messages__srv__EmotionService_Request *)allocator.zero_allocate(size, sizeof(rl_custom_messages__srv__EmotionService_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rl_custom_messages__srv__EmotionService_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rl_custom_messages__srv__EmotionService_Request__fini(&data[i - 1]);
      }
...
rl_custom_messages__srv__EmotionService_Request__Sequence__fini(rl_custom_messages__srv__EmotionService_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rl_custom_messages__srv__EmotionService_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rl_custom_messages__srv__EmotionService_Request__Sequence * array = (rl_custom_messages__srv__EmotionService_Request__Sequence *)allocator.allocate(sizeof(rl_custom_messages__srv__EmotionService_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rl_custom_messages__srv__EmotionService_Request__Sequence__init(array, size);
  if (!success) {
...
rl_custom_messages__srv__EmotionService_Request__Sequence__destroy(rl_custom_messages__srv__EmotionService_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rl_custom_messages__srv__EmotionService_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rl_custom_messages__srv__EmotionService_Request__Sequence__are_equal(const rl_custom_messages__srv__EmotionService_Request__Sequence * lhs, const rl_custom_messages__srv__EmotionService_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rl_custom_messages__srv__EmotionService_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rl_custom_messages__srv__EmotionService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rl_custom_messages__srv__EmotionService_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rl_custom_messages__srv__EmotionService_Request * data =
      (rl_custom_messages__srv__EmotionService_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rl_custom_messages__srv__EmotionService_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rl_custom_messages__srv__EmotionService_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rl_custom_messages__srv__EmotionService_Request__copy(
...
rl_custom_messages__srv__EmotionService_Response__init(rl_custom_messages__srv__EmotionService_Response * msg)
{
  ...
  // results
  if (!rosidl_runtime_c__String__init(&msg->results)) {
    rl_custom_messages__srv__EmotionService_Response__fini(msg);
    return false;
  }
  return true;
}
...
rl_custom_messages__srv__EmotionService_Response__fini(rl_custom_messages__srv__EmotionService_Response * msg)
{
  ...
  // results
  rosidl_runtime_c__String__fini(&msg->results);
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rl_custom_messages__srv__EmotionService_Response * msg = (rl_custom_messages__srv__EmotionService_Response *)allocator.allocate(sizeof(rl_custom_messages__srv__EmotionService_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rl_custom_messages__srv__EmotionService_Response));
  bool success = rl_custom_messages__srv__EmotionService_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rl_custom_messages__srv__EmotionService_Response__Sequence__init(rl_custom_messages__srv__EmotionService_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rl_custom_messages__srv__EmotionService_Response * data = NULL;

  if (size) {
    data = (rl_custom_messages__srv__EmotionService_Response *)allocator.zero_allocate(size, sizeof(rl_custom_messages__srv__EmotionService_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rl_custom_messages__srv__EmotionService_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rl_custom_messages__srv__EmotionService_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rl_custom_messages__srv__EmotionService_Response__Sequence__fini(rl_custom_messages__srv__EmotionService_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rl_custom_messages__srv__EmotionService_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rl_custom_messages__srv__EmotionService_Response__Sequence * array = (rl_custom_messages__srv__EmotionService_Response__Sequence *)allocator.allocate(sizeof(rl_custom_messages__srv__EmotionService_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rl_custom_messages__srv__EmotionService_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rl_custom_messages__srv__EmotionService_Response__Sequence__destroy(rl_custom_messages__srv__EmotionService_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rl_custom_messages__srv__EmotionService_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rl_custom_messages__srv__EmotionService_Response__Sequence__are_equal(const rl_custom_messages__srv__EmotionService_Response__Sequence * lhs, const rl_custom_messages__srv__EmotionService_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rl_custom_messages__srv__EmotionService_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rl_custom_messages__srv__EmotionService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rl_custom_messages__srv__EmotionService_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rl_custom_messages__srv__EmotionService_Response * data =
      (rl_custom_messages__srv__EmotionService_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rl_custom_messages__srv__EmotionService_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rl_custom_messages__srv__EmotionService_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rl_custom_messages__srv__EmotionService_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
