...
#include "rl_custom_messages/msg/detail/motor_commands__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // commands
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // commands

// forward declare type support functions


using _MotorCommands__ros_msg_type = rl_custom_messages__msg__MotorCommands;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: commands
  {
    ...
    if (ros_message->commands.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->commands);
    }
...
size_t get_serialized_size_rl_custom_messages__msg__MotorCommands(
  const void * untyped_ros_message,
...
static uint32_t _MotorCommands__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rl_custom_messages__msg__MotorCommands(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rl_custom_messages
size_t max_serialized_size_rl_custom_messages__msg__MotorCommands(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MotorCommands__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rl_custom_messages__msg__MotorCommands(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rl_custom_messages, msg, MotorCommands)() {
