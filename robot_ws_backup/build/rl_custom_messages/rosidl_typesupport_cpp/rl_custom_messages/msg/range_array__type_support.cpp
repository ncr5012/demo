...
static const _RangeArray_type_support_symbol_names_t _RangeArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rl_custom_messages, msg, RangeArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rl_custom_messages, msg, RangeArray)),
  }
};
...
{
  return &::rl_custom_messages::msg::rosidl_typesupport_cpp::RangeArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rl_custom_messages, msg, RangeArray)() {
  return get_message_type_support_handle<rl_custom_messages::msg::RangeArray>();
}
