...
class ImageDisplayNode(Node):
    def __init__(self):
        ...
        self.face_detected_0 = False
        self.face_detected_1 = False
        self.emotions_0 = None
        self.emotions_1 = None
    ...
    def analyze_frame(self, frame, window_name):
        ...
        if isinstance(results, list):
            for result in results:
                ...
                if x == 0 and y == 0:
                    #chatGPT -  self.face_detected_<window_name> = False
                    print("No face detected")
                else:
                    cv2.rectangle(frame, (x, y), (x+w, y+h), (255, 0, 0), 2)  # Draw a rectangle around the face
                    #chatGPT -  self.face_detected_<window_name> = True
                    ...
                    if recent_emotions:
                        ...
                        #chatGPT - self.emotions_<window_name> = average_emotions
        else:
            print("No face detected")
            #chatGPT -  self.face_detected_<window_name> = False
        ...
        #chatGPT - print both self.face_detected and self.emotions variables stored above
